...
将 DINOv3（2025，Meta AI，自监督 ViT，`facebook/dinov3-vits16-pretrain-lvd1689m`）作为 backbone，结合 PSPNet 金字塔池化模块，在 Pascal VOC 2012 上做语义分割。评价指标：mIoU（不是 mAP）。
...
- 冻结 backbone 训练时需保持 BN 在 eval 模式
